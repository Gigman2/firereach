...
// Source: engineering/guardrails/app.md
...
const RULES = [
  ...
  },
  {
    ...
    "literal": "192",
    "owner": "src/lib/stationTypes.ts",
    "scope": "**/*.{ts,tsx}",
    "context": "(emergencyNumber|phone|number)\\s*[:=]",
    "allow_paths": [
      "src/lib/__tests__/**"
    ],
    "severity": "error",
  ...
  },
  {
    ...
    "severity": "error",
    "mode": "repo",
    "title": "The Claude endpoint is not an app-side URL"
  }
];
