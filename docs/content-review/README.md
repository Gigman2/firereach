...
- **firstaid-burns** — WHO's "do not apply" list names a South Asian folk remedy that means little to a Ghanaian reader, and we removed the gloss rather than substitute our own examples. Please supply, under your own name, the substances people here actually apply to burns — shea butter, palm oil, toothpaste, ash, engine oil and the like — so the warning names what readers are actually at risk of doing.
